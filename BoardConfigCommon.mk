...
VENDOR_PATH := device/sony/loire-common
...
BOARD_KERNEL_CMDLINE := androidboot.bootdevice=7824900.sdhci msm_rtb.filter=0x3F ehci-hcd.park=3 coherent_pool=8M sched_enable_power_aware=1 user_debug=31 cgroup.memory=nokmem printk.devkmsg=on androidboot.hardware=suzu buildvariant=userdebug
...
# Display
MAX_VIRTUAL_DISPLAY_DIMENSION := 4086
